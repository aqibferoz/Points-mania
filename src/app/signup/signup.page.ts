...
user_currency_code;
  constructor(private auth: AuthService, private navCtrl: NavController,
    ...
    async register() {
      if(this.username!=null && this.country!=null){

      
      console.log(this.country);
      let a = this.countries.filter(item=>{
        return item.country==this.country
      })
      console.log(a);
      this.user_country=a[0].country;
      this.user_currency_code=a[0].currency_code;
              ...
              this.auth.signup(this.email, this.password).then((res: any) => {
                ...
                if (res.user.uid) {
                  let data = {
                    ...
                    points:0,
                    userCountry:this.user_country,
                    userCurrency:this.user_currency_code
                  }
